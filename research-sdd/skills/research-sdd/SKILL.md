...
| Unattended, dynamic halted after 1 block | Self-paced fixed-interval (fallback) | `/loop 5m /research-sdd <target>` | Harness re-fires; campaign STOP: CronDelete then disarm |
