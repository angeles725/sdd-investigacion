...
# 91 — HONESTY IN FENCED BLOCK (§912 fenced-block guard): the honesty phrase is inside a
...
# 92 — HONESTY IN HTML COMMENT (§912 comment guard): the honesty phrase is inside an HTML
