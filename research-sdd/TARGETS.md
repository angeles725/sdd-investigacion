...
| 14 | pruebas-dashboards | `/home/cristian/prototipos/pruebas-dashboards` | **mature** (40 md / 7 runs / 3 retros +1 pending / git yes / remote yes / hook deferred; 13 OCR book-extracts + 5 standard/manual extracts; `anti-ai-ui` skill delivered; B39 NUREG-0700 + B40 public-warning severity grammar (DWD Warnstufen + USGS ShakeMap/PAGER hazard-tier, G50) cross-vibra FOUNDATIONS (vibra count unchanged at 24; N1-N20 + H1-H12 lint-mining handoffs pending skill adoption), pipeline still scout-owed 40/43, G42-G47 scouts owed, G36-G38 deferred) `[CERT]` | **Design-research corpus** on anti-AI-feel dashboard design — **no binaries**; web sources (Tufte, Few, Cairo, FT Visual Vocabulary, Okabe-Ito, IBM, Observable) + book extracts + context7 library docs (ECharts, Mantine, Phosphor, etc.) `[CERT]` | `webfetch` + context7 + manual extraction into `corpus/sources/` | English `[CERT]` |
